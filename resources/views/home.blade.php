...
<div class="menu-content">
    <ul>
        <li><a class="active" href="#" data-value="about">ACERCA DE</a></li>
        <li><a href="#" data-value="skills">HABILIDADES</a></li>
        <li><a href="#" data-value="education">EDUCACIÓN</a></li>
        <li><a href="#" data-value="experience">EXPERIENCIA</a></li>
        <!-- <li><a href="#" data-value="portfolio">PORTFOLIO</a></li> -->
        <!-- <li><a href="#" data-value="testimonials">TESTIMONIOS</a></li> -->
        <li><a href="#" data-value="contact-us">CONTACTO</a></li>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="photo-profile">
                    <img src="images/front.jpg" alt="Carlos Enrique Valdés Aravena">
                </div>
                <a href="cv/cv.pdf" target="cv">
                    <div class="download-resume">
                        <i class="fa fa-cloud-download" aria-hidden="true"></i>
                        <span class="text-download">DESCARGAR CV</span>
                    </div>
                </a>
                <div class="available">
                    <i class="fa fa-check" aria-hidden="true"></i>
                    <span class="text-available">Disponible como Freelance</span>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="info-profile">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="ul-info">
                                <li class="li-info">
                                    <span class="title-info">Edad</span>
                                    <span class="info">24</span>
                                </li>
                                <li class="li-info">
                                    <span class="title-info">Dirección</span>
                                    <span class="info">110, Estación Central, Santiago</span>
                                </li>
                                <li class="li-info">
                                    <span class="title-info">Email</span>
                                    <span class="info">valdescarlos17@gmail.com</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <span class="title-links">Redes Sociales</span>
        ...
        <div class="col-md-6">
            <div class="professional-skills">
                ...
                <div class="skill">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress3" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 65%;">
                        </div>
                    </div>
                </div>
                <!-- / single skill -->
                ...
                <div class="skill">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress4" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 75%;">
                        </div>
                    </div>
                </div>
                <!-- / single skill -->
                ...
                <div class="skill">
                    <div class="title-progress">
                        <span class="skill-name">CodeIgniter</span>
                        <span class="skill-value">70%</span>
                    </div>
                    <div class="progress">
                        <div class="progress-bar progress2" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
...
<section id="education" class="section section-education wow fadeInUp" data-wow-offset="40">
    <div class="header-section">
        <h2 class="h2-section">EDUCACIÓN</h2>
    </div>
    <div class="row">
        <!-- single education -->
                ...
                <ul class="ul-education">
                    <li class="li-specialty">
                        <div class="specialty">
                            ...
                            <span class="specialty-name">Ingeniería en Informática</span>
                        </div>
                    </li>
                    <li class="li-university">
                        <div class="university">
                            <span class="education-icon"><i class="fa fa-university"></i></span>
                            <span class="university-name">Universidad Tecnológica de Chile INACAP</span>
                        </div>
                    </li>
                </ul>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="item-portfolio term3">
                <div class="item-overlay">
                    <div class="item-content">
                        <span class="icon-search">
                            <a class="work-popup" href="http://placehold.it/600x600" data-group="1"><i class="fa fa-search" aria-hidden="true"></i></a>
                        </span>
                ...
                <img src="http://placehold.it/303x303" alt="">
            </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="personal-info">
                    <img src="http://placehold.it/103x105" alt="">
                    <h3>Chris Smith</h3>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="blog-content">
                <img src="http://placehold.it/470x300" alt="">
...
<section id="contact-us" class="section section-contact-us wow fadeInUp" data-wow-offset="40">
    <div class="header-section">
        <h2 class="h2-section">CONTACTO</h2>
    </div>
    <div class="row">
        <div class="col-sm-7">
            <div class="form-content">
                <h3>HAS TU CONSULTA</h3>
        ...
        <div class="col-sm-5">
            <div class="info-content">
                ...
                <div class="address">
                    ...
                    <span class="info-text">Santiago, Estación Central</span>
                </div>
                <div class="email">
                    <span class="info-icon"><i class="fa fa-envelope"></i></span>
                    <span class="info-text">valdescarlos17@gmail.com</span>
                </div>
                <div class="telephone">
